<!DOCTYPE html>
<!-- saved from url=(0088)http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html -->
<html lang="en" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style>.jquery-ripples { position: relative; z-index: 0; }</style>
    <!-- Meta Tags -->
    ...
    <!-- Icon fonts -->
    <link href="Lovly/font-awesome.min.css" rel="stylesheet">
    <link href="Lovly/flaticon.css" rel="stylesheet">

    <!-- Bootstrap core CSS -->
    <link href="Lovly/bootstrap.min.css" rel="stylesheet">

    <!-- Plugins for this template -->
    <link href="Lovly/animate.css" rel="stylesheet">
    <link href="Lovly/owl.carousel.css" rel="stylesheet">
    <link href="Lovly/owl.theme.css" rel="stylesheet">
    <link href="Lovly/slick.css" rel="stylesheet">
    <link href="Lovly/slick-theme.css" rel="stylesheet">
    <link href="Lovly/owl.transitions.css" rel="stylesheet">
    <link href="Lovly/jquery.fancybox.css" rel="stylesheet">
    <link href="Lovly/magnific-popup.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="Lovly/style.css" rel="stylesheet">
    ...
    <div class="page-wrapper">
        ...
        <div class="music-box">
            ...
            <div class="music-holder">
                <iframe src="Lovly/saved_resource.html"></iframe>
            </div>
        </div>
        <!-- end music box -->
        ...
        <header id="header" class="site-header header-style-2">
            <nav class="navigation navbar navbar-default original" style="visibility: hidden;">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <div class="couple-logo">
                            <h1><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#home">S <i class="fi flaticon-shape-1"></i> F</a></h1>
                        </div>
                    </div>
                    <div id="navbar" class="navbar-collapse collapse navbar-right navigation-holder">
                        <button class="close-navbar"><i class="fa fa-close"></i></button>
                        <ul class="nav navbar-nav">
                            <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#home">Home</a></li>
                            <li class=""><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#couple">Couple</a></li>
                            <li class=""><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#story">Story</a></li>
                            <li class=""><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#events">Events</a></li>
                            <li class="current-menu-item"><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#people">People</a></li>
                            <li class=""><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#gallery">Gallery</a></li>
                            <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#rsvp">RSVP</a></li>
                            <li class="menu-item-has-children">
                                <a href="javascript:void(0);">Blog</a>
                                <ul class="sub-menu" style="display: block;">
                                    <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/blog.html">Blog</a></li>
                                    <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/blog-details.html">Blog Details</a></li>
                                    <li class="menu-item-has-children">
                                        <a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#Level3">Thidr level</a>
                                        <ul class="sub-menu" style="display: block;">
                                            <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#">Level3</a></li>
                                            <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#">Level3</a></li>
                                            <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#">Level3</a></li>
                                        </ul>
                                    </li>
            ...
            </nav><nav class="navigation navbar navbar-default sticky-2 sticky-on" style="width: 1356px;">
                <div class="container">
                    <div class="navbar-header">
                        <button type="button" class="open-btn">
                            <span class="sr-only">Toggle navigation</span>
        ...
        <section class="hero">
            <div class="hero-slider hero-slider-s1 slick-initialized slick-slider slick-dotted" role="toolbar"><button type="button" class="slick-prev slick-arrow" style="display: block;">Previous</button>
                <div aria-live="polite" class="slick-list draggable"><div class="slick-track" role="listbox" style="opacity: 1; width: 2712px;"><div class="slide-item slick-slide slick-current slick-active" style="background-image: url(&quot;images/slider/slide-1.jpg&quot;); background-size: cover; background-position: center center; width: 1356px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;" data-slick-index="0" aria-hidden="false" tabindex="-1" role="option" aria-describedby="slick-slide00">
                    <img src="Lovly/slide-1.jpg" alt="" class="slider-bg">
                </div><div class="slide-item slick-slide" style="background-image: url(&quot;images/slider/slide-2.jpg&quot;); background-size: cover; background-position: center center; width: 1356px; position: relative; left: -1356px; top: 0px; z-index: 998; opacity: 0;" data-slick-index="1" aria-hidden="true" tabindex="-1" role="option" aria-describedby="slick-slide01">
            ...
            <div class="wedding-announcement">
                <div class="couple-name-merried-text">
                    <h2 class="wow slideInUp" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: slideInUp;">Ade &amp; Irma</h2>
                    ...
                    <div class="col col-xs-12">
                        <div class="gb groom">
                            <div class="img-holder wow fadeInLeftSlow" style="background-image: url(&quot;images/couple/img-1.jpg&quot;); background-size: cover; background-position: center center; visibility: visible; animation-name: fadeInLeftSlow;">
                                <img src="Lovly/img-1.jpg" alt="">
                            </div>
                            <div class="details" style="height: 456px;">
                                <div class="details-inner">
                                    <h3>The groom</h3>
                                    <p>Hi I am Ade , dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
                                    <span class="signature">Ade</span>
                                    <ul class="social-links">
                                        <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#"><i class="fa fa-facebook"></i></a></li>
                                        <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#"><i class="fa fa-pinterest"></i></a></li>
                                        <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#"><i class="fa fa-google-plus"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="gb bride">
                            <div class="details" style="height: 456px;">
                                <div class="details-inner">
                                    <h3>The Bride</h3>
                                    <p>Hi I am Ade , dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries.</p>
                                    <span class="signature">Irma</span>
                                    <ul class="social-links">
                                        <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#"><i class="fa fa-facebook"></i></a></li>
                                        <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#"><i class="fa fa-pinterest"></i></a></li>
        ...
        <section class="count-down-section section-padding parallax" data-bg-image="images/countdown-bg.jpg" data-speed="7" style="background-image: url(&quot;images/countdown-bg.jpg&quot;); background-position: 50% 537.429px; background-size: cover;">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col col-md-7 col-md-offset-1">
                        <div class="count-down-clock">
                            <div id="clock"><div class="box"><div>00</div> <span>Days</span> </div><div class="box"><div>00</div> <span>Hours</span> </div><div class="box"><div>00</div> <span>Mins</span> </div><div class="box"><div>00</div> <span>Secs</span> </div></div>
                        </div>
                    </div>
                </div> <!-- end row -->
            </div> <!-- end container -->
        ...
        <!-- start cta -->
        <section class="cta section-padding parallax" data-bg-image="images/cta-bg.jpg" data-speed="7" style="background-image: url(&quot;images/cta-bg.jpg&quot;); background-position: 50% 224.272px; background-size: cover;">
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col col-lg-10 col-lg-offset-1">
                        <div class="event">
                            <div class="img-holder">
                                <img src="Lovly/img-1(2).jpg" alt="" class="img img-responsive">
                            </div>
                            <div class="details">
                                <h3>The reception</h3>
                                <ul>
                        ...
                        <div class="event">
                            <div class="img-holder">
                                <img src="Lovly/img-2(2).jpg" alt="" class="img img-responsive">
                            </div>
                            <div class="details">
                                <h3>Wedding party</h3>
                                <ul>
                    ...
                    <div class="col col-xs-12">
                        <div class="inportant-people-content">
                            <div class="tablist">
                                <ul class="nav">
                                    <li class="active">
                                        <a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#groomsmen" data-toggle="tab">Groomsmen</a>
                                    </li>
                                    <li>
                                        <a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#bridesmaid" data-toggle="tab">Bridesmaid</a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active grid-wrapper" id="groomsmen">
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="Lovly/img-1(3).jpg" class="popup-image">
                                                <img src="Lovly/img-1(3).jpg" alt="" class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Jhon Michel</h3>
                                            ...
                                            <ul class="social-links">
                                                ...
                                                <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#"><i class="fa fa-twitter"></i></a></li>
                                                <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#"><i class="fa fa-pinterest"></i></a></li>
                                                <li><a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#"><i class="fa fa-vimeo"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="Lovly/img-2(3).jpg" class="popup-image">
                                                <img src="Lovly/img-2(3).jpg" alt="" class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Chasmoos jhon</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="Lovly/img-3(1).jpg" class="popup-image">
                                                <img src="Lovly/img-3(1).jpg" alt="" class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Kaiste pate</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="Lovly/img-4.jpg" class="popup-image">
                                                <img src="Lovly/img-4.jpg" alt="" class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Hatu Michel</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="Lovly/img-5(1).jpg" class="popup-image">
                                                <img src="Lovly/img-5(1).jpg" alt="" class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Michel doin</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="Lovly/img-6.jpg" class="popup-image">
                                                <img src="Lovly/img-6.jpg" alt="" class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Topper jone</h3>
                                ...
                                <div class="tab-pane fade grid-wrapper" id="bridesmaid">
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="Lovly/img-1(4).jpg" class="popup-image">
                                                <img src="Lovly/img-1(4).jpg" alt="" class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Rachel Li</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="Lovly/img-2(4).jpg" class="popup-image">
                                                <img src="Lovly/img-2(4).jpg" alt="" class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Male Vign</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="Lovly/img-3(2).jpg" class="popup-image">
                                                <img src="Lovly/img-3(2).jpg" alt="" class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Jonny Mich</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="Lovly/img-4(1).jpg" class="popup-image">
                                                <img src="Lovly/img-4(1).jpg" alt="" class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Brodd Wid</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="Lovly/img-5(2).jpg" class="popup-image">
                                                <img src="Lovly/img-5(2).jpg" alt="" class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Nokshal bedi</h3>
                                    ...
                                    <div class="grid">
                                        <div class="img-holder">
                                            <a href="Lovly/img-6(1).jpg" class="popup-image">
                                                <img src="Lovly/img-6(1).jpg" alt="" class="img img-responsive">
                                            </a>
                                        </div>
                                        <div class="details">
                                            <h3>Holly Fie</h3>
                ...
                <div class="row">
                    <div class="col col-xs-12 sortable-gallery">
                        <div class="gallery-filters">
                            <ul>
                                <li><a data-filter="*" href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#" class="current">All</a></li>
                                <li><a data-filter=".wedding" href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#">Wedding</a></li>
                                <li><a data-filter=".ceremony" href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#">Ceremony</a></li>
                                <li><a data-filter=".party" href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#">Party</a></li>
                            </ul>
                        </div>

                        <div class="gallery-container gallery-fancybox masonry-gallery" style="position: relative; height: 1046.23px;">
                            <div class="grid wedding" style="position: absolute; left: 0%; top: 0px;">
                                <a href="Lovly/img-1(5).jpg" class="fancybox" data-fancybox-group="gall-1">
                                    <img src="Lovly/img-1(5).jpg" alt="" class="img img-responsive">
                                </a>
                            </div>
                            <div class="grid wedding ceremony" style="position: absolute; left: 33.2468%; top: 0px;">
                                <a href="Lovly/img-2(5).jpg" class="fancybox" data-fancybox-group="gall-1">
                                    <img src="Lovly/img-2(5).jpg" alt="" class="img img-responsive">
                                </a>
                            </div>
                            <div class="grid ceremony eudcation" style="position: absolute; left: 66.5801%; top: 0px;">
                                <a href="Lovly/img-3(3).jpg" class="fancybox" data-fancybox-group="gall-1">
                                    <img src="Lovly/img-3(3).jpg" alt="" class="img img-responsive">
                                </a>
                            </div>
                            <div class="grid wedding party" style="position: absolute; left: 0%; top: 261px;">
                                <a href="Lovly/img-4(2).jpg" class="fancybox" data-fancybox-group="gall-1">
                                    <img src="Lovly/img-4(2).jpg" alt="" class="img img-responsive">
                                </a>
                            </div>
                            <div class="grid ceremony" style="position: absolute; left: 33.2468%; top: 292px;">
                                <a href="Lovly/img-5(3).jpg" class="fancybox" data-fancybox-group="gall-1">
                                    <img src="Lovly/img-5(3).jpg" alt="" class="img img-responsive">
                                </a>
                            </div>
                            <div class="grid party" style="position: absolute; left: 66.5801%; top: 372px;">
                                <a href="Lovly/img-6(2).jpg" class="fancybox" data-fancybox-group="gall-1">
                                    <img src="Lovly/img-6(2).jpg" alt="" class="img img-responsive">
                                </a>
                            </div>
                            <div class="grid wedding" style="position: absolute; left: 33.2468%; top: 628px;">
                                <a href="Lovly/img-7(1).jpg" class="fancybox" data-fancybox-group="gall-1">
                                    <img src="Lovly/img-7(1).jpg" alt="" class="img img-responsive">
                                </a>
                            </div>
                            <div class="grid ceremony" style="position: absolute; left: 66.5801%; top: 634px;">
                               <!--  <a href="images/gallery/img-8.jpg" class="fancybox" data-fancybox-group="gall-1">
                                ...
                                <a href="https://www.youtube.com/embed/XSGBVzeBUbk?autoplay=1" data-type="iframe" class="video-play-btn">
                                    <img src="Lovly/img-8(1).jpg" alt="" class="img img-responsive">
                                    <i class="fa fa-play"></i>
                                </a>

                            </div>
                            <div class="grid ceremony" style="position: absolute; left: 0%; top: 709px;">
                                <a href="Lovly/img-9.jpg" class="fancybox" data-fancybox-group="gall-1">
                                    <img src="Lovly/img-9.jpg" alt="" class="img img-responsive">
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <!-- start rsvp-section -->
        <section class="rsvp-section section-padding parallax" data-bg-image="images/rsvp-bg.jpg" data-speed="7" id="rsvp" style="background-image: url(&quot;images/rsvp-bg.jpg&quot;); background-position: 50% -392.529px; background-size: cover;">
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
                ...
                <div class="row content">
                    <div class="col col-lg-10 col-lg-offset-1">
                        ...
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1260px, 0px, 0px); transition: all 1s ease 0s; width: 3485px; padding-left: 10px; padding-right: 10px;"><div class="owl-item cloned" style="width: 295px; margin-right: 20px;"><div class="register">
                                ...
                                <img src="Lovly/img-1(6).jpg" alt="" class="img img-responsive">
                            </div></div><div class="owl-item cloned" style="width: 295px; margin-right: 20px;"><div class="register">
                                <img src="Lovly/img-2(6).jpg" alt="" class="img img-responsive">
        ...
        <footer class="site-footer">
            <div class="back-to-top">
                <a href="http://irsfoundation.com/tf/templates/wedding/lovely-wedding/lovely-wedding/index-2.html#" class="back-to-top-btn"><span><i class="fi flaticon-cupid"></i></span></a>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
