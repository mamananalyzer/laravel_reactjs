...
<html lang="en" class=""><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style>.jquery-ripples { position: relative; z-index: 0; }</style>
    ...
    <link href="Lovly/images/favicon/favicon.png" rel="shortcut icon" type="image/png">
    <link href="Lovly/images/favicon/apple-touch-icon.png" rel="apple-touch-icon">
    <link href="Lovly/images/favicon/apple-touch-icon-72x72.png" rel="apple-touch-icon" sizes="72x72">
    <link href="Lovly/images/favicon/apple-touch-icon-114x114.png" rel="apple-touch-icon" sizes="114x114">
    <link href="Lovly/images/favicon/apple-touch-icon-144x144.png" rel="apple-touch-icon" sizes="144x144">
...
<body id="home">
    ...
    <div class="page-wrapper">
        ...
        <header id="header" class="site-header header-style-1">
            ...
            </nav><nav class="navigation navbar navbar-default sticky">
                <div class="container">
                    <div class="navbar-header">
                        <button type="button" class="open-btn">
                            <span class="sr-only">Toggle navigation</span>
